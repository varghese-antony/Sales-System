...
<body style="margin:0;padding:32px 24px;background:#fff;font-family:Arial,sans-serif;">
  ...
  try {
    ...
    const now = new Date()
    // Timezone-aware: 12:00 UTC 3 days from now → caught by 13:00 UTC cron
    // US EST receives at 8am, UK at 1pm, UAE at 5pm (see send-window.js for full table)
    const nextDue = getNextDueAt(country, 3)
