...
import { Lightbulb, Sun, Menu, LayoutDashboard, User, LogOut, UserCircle, Shield } from "lucide-react"
                  ...
                  {user ? (
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button variant="ghost" className="flex items-center justify-center px-3 py-2 relative h-10 w-10">
                          <UserCircle className="w-4 h-4" />
                          <span className="sr-only">Open user menu</span>
                          {isAdmin && (
                            <Badge
                              variant="secondary"
                              className="absolute -top-0.5 -right-0.5 h-5 w-5 rounded-full p-0 flex items-center justify-center bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300"
                            >
                              <Shield className="w-3 h-3" />
                              <span className="sr-only">Administrator account</span>
                            </Badge>
                          )}
                        </Button>
                      </DropdownMenuTrigger>
                  ...
                  <DropdownMenuTrigger asChild>
                    ...
                    >
                      ...
                      {isAdmin && (
                        <Badge
                          variant="secondary"
                          className="absolute -top-0.5 -right-0.5 h-4 w-4 rounded-full p-0 flex items-center justify-center bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300"
                        >
                          <Shield className="w-3 h-3" />
                          <span className="sr-only">Administrator account</span>
                        </Badge>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="ghost" className="h-10 w-10 p-0">
                      <UserCircle className="w-5 h-5" />
                      <span className="sr-only">Open authentication menu</span>
                    </Button>
                  </DropdownMenuTrigger>
